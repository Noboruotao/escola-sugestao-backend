...
class AlunoFactory extends Factory
{
    ...
    private static function generateRandomNota($target, $probability = 0.8, $faker)
    {
    ...
    {
        $nota_p1 = self::generateRandomNota(3.00, null, $faker);
        $nota_p2 = self::generateRandomNota(3.00, null, $faker);
        $nota_sub = null;
